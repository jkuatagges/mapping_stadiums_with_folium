...
for lt,ln,nm,cp,ws,pic in zip(LAT, LON,name,capacity,website,picture):
    ...
    popup="<b>name  : </b>"+nm+ "<br> <b>capacity : </b> "+str(cp)+"<br><b>wikipidea link: </b><a href="+ws+">Click here</a>"+"<br> <img src="+pic+" height=142 width=290>",icon=folium.Icon(color='green')))
